...
class GitHubClient:
    ...
    def create_documentation_pr(
        ...
        branch_name = f"schema-doc-bot/metadata-update-{timestamp}"
    ...
    def _generate_pr_body(self, schema_updates: list[SchemaUpdate]) -> str:
        ...
        body = f"""## 🤖 Schema Documentation Update

This PR was automatically generated by **Schema Doc-Bot** to add missing documentation to Avro schemas.
...
*Generated by [Schema Doc-Bot](https://github.com/schema-doc-bot)*
"""
        return body
